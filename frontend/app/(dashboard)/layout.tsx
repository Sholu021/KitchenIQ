...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // Set formatted current date on client side
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex overflow-hidden">
      ...
      >
        ...
        <div className={`h-16 flex items-center justify-between border-b border-slate-800/80 ${collapsed ? 'px-4' : 'px-6'}`}>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-bold text-white truncate leading-snug">{userName || 'User Name'}</p>
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <span className="text-[10px] font-semibold text-slate-400 uppercase">{role || 'Staff'}</span>
          ...
          <div className="w-64 bg-[#0f172a] border-r border-slate-800 flex flex-col animate-in slide-in-from-left duration-200">
            <div className="h-16 flex items-center justify-between px-6 border-b border-slate-800">
              <div className="flex items-center gap-2">
                ...
                <span className="text-base font-black text-white tracking-tight">KitchenIQ AI</span>
              </div>
              <button
